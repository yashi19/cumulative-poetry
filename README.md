...
Flags supported 
- `--reveal-for-day for_which_day [--random] [--seed seed_value]` : Reveals the tale up till that day, optionally in a random order
- `--recite [--random] [--seed seed_value]` : Recites the whole tale with a day wise breakage, optionally in a random order
